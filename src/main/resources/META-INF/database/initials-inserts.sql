...
insert into purchase (id, client_id, purchase_date, total, status) values (1, 1, date_sub(sysdate(), interval 5 day), 2398.0, 'PAID_OUT');
insert into purchase (id, client_id, purchase_date, total, status) values (2, 1, sysdate(), 499.0, 'WAITING');
insert into purchase (id, client_id, purchase_date, total, status) values (3, 1, date_sub(sysdate(), interval 2 day), 3500.0, 'PAID_OUT');
insert into purchase (id, client_id, purchase_date, total, status) values (4, 2, date_sub(sysdate(), interval 2 day), 499.0, 'WAITING');
